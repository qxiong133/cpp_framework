...
class MajorDomoWorker(object):
    ...
    def reconnect_to_broker(self):
        ...
        self.worker.setsockopt(zmq.IDENTITY, b'python_worker01')
        ...
        self.send_to_broker(MDP.W_READY, self.service, b'ServiceDoNotWaitResponse', [])
    ...
    def send_to_broker(self, command, option=None, service_type=None, msg=None):
        ...
        if self.verbose:
            logging.info("I: sending %s to broker", ord(command))
            dump(msg)

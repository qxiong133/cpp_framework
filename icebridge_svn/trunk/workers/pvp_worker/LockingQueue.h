/**
 * @file LockingQueue.hpp Thread-safe queue-like container template class.
...
>
class LockingQueue : boost::noncopyable {
private:
    /**
     * Lock guard type.
     */
...
public:
     ...
     */
    explicit LockingQueue(const container_type& other)
